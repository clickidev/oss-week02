...
console.log(2, 1 === "1");           // prediction:2 true
...
console.log(11, typeof "4");         // prediction:11 number
console.log(12, typeof null);        // prediction:12 object
console.log(13, typeof []);          // prediction:13 object
console.log(14, [1, 2] == [1, 2]);   // prediction:14 true
console.log(15, NaN === NaN);        // prediction:15 trueq
